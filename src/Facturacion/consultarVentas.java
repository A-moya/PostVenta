...
public class consultarVentas extends javax.swing.JDialog {
    ...
    public consultarVentas(java.awt.Frame parent, boolean modal, FacturaDetalle facDtalle) {
        super(parent, modal);
        initComponents();
    ...
    private void pasar() {
        ...
        int colum = TablaVenta.getSelectedColumnCount();

        if (fila >= 0 && colum == 1) {
            
            //Capturar los datos de la tabla para pasarlos a la otra interfaz
            String id = TablaVenta.getValueAt(fila, 0).toString();
            String usu = TablaVenta.getValueAt(fila, 1).toString();
            String fecha = TablaVenta.getValueAt(fila, 2).toString();
            String ttal = TablaVenta.getValueAt(fila, 4).toString();
            
            
            FacturaDetalle dialog = new FacturaDetalle(new javax.swing.JFrame(), true,id,usu,fecha,ttal);
            dialog.setVisible(true);
        }
    }
